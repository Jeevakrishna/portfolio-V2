...
[Install VSCode Great Icons here!](https://marketplace.visualstudio.com/items?itemName=emmanuelbeziat.vscode-great-icons)
...
[Install Auto Close Tags here!](https://marketplace.visualstudio.com/items?itemName=formulahendry.auto-close-tag)
...
[Install Auto Rename Tags here!](https://marketplace.visualstudio.com/items?itemName=formulahendry.auto-rename-tag)
...
[You'll want to make sure you install Bracket Pair Colorizer!](https://marketplace.visualstudio.com/items?itemName=CoenraadS.bracket-pair-colorizer-2)
...
[Install Indent Rainbow!](https://marketplace.visualstudio.com/items?itemName=oderwat.indent-rainbow)
...
[Check out iTunes & Apple Music Player here!](https://marketplace.visualstudio.com/items?itemName=PsykoSoldi3r.itunes-vscode)
...
[Install Prettier here!](https://marketplace.visualstudio.com/items?itemName=esbenp.prettier-vscode)
...
[ESLint can be installed here!](https://marketplace.visualstudio.com/items?itemName=dbaeumer.vscode-eslint)
...
[Install the Docker extension here!](https://marketplace.visualstudio.com/items?itemName=ms-azuretools.vscode-docker)
