...
export default function SpeakingPage() {
  return (
    <div className="relative">
      <title>Failures | Jeevakrishna</title>
      <div className="relative space-y-16">
        <GridWrapper>
          <h1 className="max-w-3/5 mx-auto mt-16 text-balance text-center text-4xl font-medium leading-tight tracking-tighter text-text-primary md:text-6xl md:leading-[64px]">
            Failure is success is progress
          </h1>
        </GridWrapper>
                ...
                <div className="col-span-5 flex flex-col items-start space-y-8">
                  ...
                  <div className="mt-12 flex w-full space-x-4">
                    <div className="relative">
                      ...
                      <div className="absolute left-1 top-2 h-[186px] w-[186px] rotate-[9deg] rounded-lg overflow-hidden shadow">
                        <Image
                          src="/braydon_headshot_3.jpg"
                          alt="Braydon Coyer headshot"
                          width={186}
                          height={186}
                    ...
                    <div className="relative">
                      <ShadowBox width={200} height={200}></ShadowBox>
                      <div className="absolute left-1 top-2 h-[186px] w-[186px] rotate-[-8deg] rounded-lg overflow-hidden shadow">
                        <Image
                          src="/braydon_speaking_photo_square.jpg"
                          alt="Braydon Coyer speaking"
                          width={186}
                          height={186}
                          className="h-full w-full object-cover"
                        />
