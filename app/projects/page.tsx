...
const projects: Project[] = [
  ...
  },
  {
    title: "Pradient",
    description:
      "Pradient is a web-based gradient solution that allows you to find, save and craft gradients with a creative community!",
    image: "/projects/pradient_project.jpeg",
    url: "https://www.pomegradient.com/",
  },
];
  ...
  return (
    <div className="relative w-full h-full">
      <Image 
        src={props.src} 
        alt={props.alt} 
        className="drama-shadow rounded-xl object-cover"
        fill
